...
export const tools: Tool[] = [
  ...
  },
  {
    id: "code-analyzer",
    name: "Code Analyzer",
    description: "Analyze code and get intelligent suggestions (No API keys)",
  ...
  },
  {
    id: "code-explainer",
    name: "Code Explainer",
    description: "Understand what your code does (No API keys)",
  ...
  },
  {
    ...
    description: "Generate OpenAPI, Postman, and cURL docs",
